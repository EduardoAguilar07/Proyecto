...
{
    public class CuentaAdminController : Controller
    {
        ...
        // GET: Account
        [HttpGet]
        public ActionResult InicioSesionAdmin()
        {
            return View();
        }
        ...
        public ActionResult Verify(Account acc)
        {
            ...
            com.CommandText = "select * from loginAdmin where username='" + acc.Name + "' and password='" + acc.Password + "'";
